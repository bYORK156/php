...
foreach($produits as $index ){
    ...
    $url=" PAGE02.php?article=".urlencode($index["article"])."&couleur=".urlencode($index["couleur"])."&description=".urlencode($index["description"])."&prix=".urlencode($index["prix"]);
...
<p>exemple : </p>
<?php
echo '<a href="PAGE02.php?nom=Jean Pierre&ville=St-Étienne">Aller</a>';
...
$url = 'PAGE02.php?nom=' . urlencode($nom) . '&ville=' . urlencode($ville);
